...
// Public venues endpoint (for all users to browse venues)
const publicVenuesRouter = express.Router();

publicVenuesRouter.get(
  "/",
  authRequired,
  async (req, res) => {
    try {
...
module.exports.publicVenuesRouter = publicVenuesRouter;
